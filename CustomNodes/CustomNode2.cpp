...
float CustomNode2::GetData() const
{
	return Data;
}

void CustomNode2::SetData(float NewValue)
{
	Data = NewValue;
}

std::string CustomNode2::GetStringData() const
{
	return StringData;
}

void CustomNode2::SetStringData(std::string NewValue)
{
	StringData = NewValue;
}
