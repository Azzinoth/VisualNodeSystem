...
LoopNode::LoopNode() : BaseExecutionFlowNode()
{
	...
	AddSocket(new NodeSocket(this, "INT", "Start Index", NodeSocket::SocketFlow::Input));
	AddSocket(new NodeSocket(this, "INT", "Last Index", NodeSocket::SocketFlow::Input));

	AddSocket(new NodeSocket(this, "EXECUTE", "Loop Body", NodeSocket::SocketFlow::Output));
	AddSocket(new NodeSocket(this, "INT", "Index", NodeSocket::SocketFlow::Output));
